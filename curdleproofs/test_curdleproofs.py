...
from util import affine_to_projective, point_affine_to_bytes, point_projective_to_bytes, points_affine_to_bytes, points_projective_to_bytes, get_random_point, get_permutation
from transcript import CurdleproofsTranscript
from typing import List, Optional, Tuple, Type, TypeVar
from util import PointAffine, PointProjective, Fr, field_to_bytes, invert, generate_blinders, inner_product, get_verification_scalars_bitstring
...
def test_same_permutation_proof():
  ...
  A = add(compute_MSM(crs_G_vec, vec_a_permuted), compute_MSM(crs_H_vec, vec_a_blinders))
